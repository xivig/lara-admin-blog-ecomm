                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown @@about">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdown03">
                                        <li><a class="dropdown-item @@company" href="{{url('/about')}}">Our company</a></li>
                                        <li><a class="dropdown-item @@pricing" href="{{url('/pricing')}}">Pricing</a></li>
                                ...
                                <li class="nav-item @@service"><a class="nav-link" href="{{url('/services')}}">Services</a></li>
                                <li class="nav-item @@project"><a class="nav-link" href="{{url('/project')}}">Portfolio</a></li>
                                <li class="nav-item dropdown @@blog">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdown05">
                                        <li><a class="dropdown-item @@blogGrid" href="{{url('/blog')}}">Blog Grid</a></li>
