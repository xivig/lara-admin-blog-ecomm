            ...
            <div class="table-responsive">
                <table class="table email-table no-wrap table-hover v-middle">
                    ...
                    <tr class="unread">
                        ...
                        <!-- User -->
                        <td class="user-image"><img src="<?php echo e(asset('user/assets/images/users/1.jpg')); ?>" alt="user"
                    ...
                    <tr class="unread">
                        ...
                        <td class="starred"><i class="far fa-star"></i></td>
                        <!-- User -->
                        <td class="user-image"><img src="<?php echo e(asset('user/assets/images/users/2.jpg')); ?>" alt="user"
                                                    class="rounded-circle" width="30"></td>
                        <td class="user-name">
                    ...
                    <tr class="unread">
                        ...
                        <td class="starred"><i class="far fa-star"></i></td>
                        <!-- User -->
                        <td class="user-image"><img src="<?php echo e(asset('user/assets/images/users/3.jpg')); ?>" alt="user"
                                                    class="rounded-circle" width="30"></td>
                    ...
                    <tr class="">
                        ...
                        <td class="starred"><i class="far fa-star"></i></td>
                        <!-- User -->
                        <td class="user-image"><img src="<?php echo e(asset('user/assets/images/users/4.jpg')); ?>" alt="user"
                                                    class="rounded-circle" width="30"></td>
                        <td class="user-name">
                    ...
                    <tr class="">
                        ...
                        <td class="starred"><i class="far fa-star"></i></td>
                        <!-- User -->
                        <td class="user-image"><img src="<?php echo e(asset('user/assets/images/users/5.jpg')); ?>" alt="user"
                                                    class="rounded-circle" width="30"></td>
                        <td class="user-name">
        ...
        <div class="right-part mail-details bg-white" style="display: none;">
            ...
            <div class="card-body border-bottom">
                <div class="d-flex no-block align-items-center m-b-40">
                    <div class="m-r-10"><img src="<?php echo e(asset('user/assets/images/users/1.jpg')); ?>" alt="user" class="rounded-circle"
                                             width="45"></div>
                    <div class="">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <a href="javascript:void(0)"> <img class="img-thumbnail img-responsive" alt="attachment"
                                                           src="<?php echo e(asset('user/assets/images/big/img1.jpg')); ?>"> </a>
                    </div>
                    <div class="col-md-2">
                        <a href="javascript:void(0)"> <img class="img-thumbnail img-responsive" alt="attachment"
                                                           src="<?php echo e(asset('user/assets/images/big/img2.jpg')); ?>"> </a>
                    </div>
                    <div class="col-md-2">
                        <a href="javascript:void(0)"> <img class="img-thumbnail img-responsive" alt="attachment"
                                                           src="<?php echo e(asset('user/assets/images/big/img3.jpg')); ?>"> </a>
                    </div>
                </div>
...
<?php echo $__env->make('user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\0.ProjectAll\laravel_all\lara-admin-blog-ecomm\resources\views/auth/inbox.blade.php ENDPATH**/ ?>